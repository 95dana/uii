...
<?php 
	...
	?>
	<p>Halo <b><?php echo $_SESSION['pelanggan']; ?></b> Anda telah login sebagai <b><?php echo $_SESSION['level']; ?></b>.</p>
...
<form action="input-aksi.php" method="post">
  <tr>
   <td>Nomer</td>
   <td><input type="text" name="nomer" size="30"></td>
  </tr>
  <tr>
   <td>Nama Tim</td>
  ...
  <tr>
   <td>Lapangan</td>
   <td><input type="text" name="lapangan" size="30"></td>
  </tr>
  <tr>
   <td>Tanggal Main</td>
   <td><input type="text" name="tanggal_main" size="30"></td>
  </tr>
  <tr>
   <td>Jam</td>
   <td><input type="text" name="jam" size="30"></td>
  </tr>
  <tr>
